...
This skill is designed for the Moltis. It uses Moltis tools, delegation, scheduling, and memory for the full research lifecycle.
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.moltis/plans/` | `skill_view("plan")` |
