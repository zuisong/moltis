...
Use [OpenCode](https://opencode.ai) as an autonomous coding worker orchestrated by Moltis terminal/process tools. OpenCode is a provider-agnostic, open-source AI coding agent with a TUI and CLI.
