...
```bash
source "${SKILL_DIR}/skills/github/github-auth/scripts/gh-env.sh"
...
gh pr review $PR_NUMBER --approve --body "Reviewed by agent. Code looks clean — good test coverage, no security concerns."
