const projects = {
  title: "Repositories",
  description: "Projects bind sessions to a codebase directory. When a session is linked to a project, context files (CLAUDE.md, AGENTS.md, .cursorrules, and rule directories) are loaded automatically, scanned for risky prompt-injection patterns, and injected into the system prompt. Enable auto-worktree to give each session its own git branch for isolated work.",
  ...
  confirmClearAll: "Clear all repositories from Moltis? This only removes them from the list and does not delete files on disk.",
