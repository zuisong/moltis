const hooks = {
  ...
  title: "Hooks",
  reloading: "Reloading…",
  introDescriptionBody: "run shell commands in response to lifecycle events (tool calls, messages, sessions, etc.). They live in",
  introDescriptionSuffix: "directories.",
  introHookMdPrefix: "Each hook is a directory containing a",
  introHookMdMiddle: "file with TOML frontmatter (events, command, requirements) and optional documentation. Edit the content below and click",
