const skills = {
  ...
  securityIntro: "技能是社区编写的指令，AI 代理以 <strong>你的完整系统权限</strong> 执行。流行度或下载量并不意味着技能是安全的。恶意技能可以指示代理：",
  ...
  securityReview: "在启用每个技能之前，请仔细检查源代码。阅读完整的 SKILL.md 及其引用的所有脚本 — 这些是代理将代你执行的确切指令。不要仅因为技能流行、下载量高或出现在排行榜上就信任它。",
